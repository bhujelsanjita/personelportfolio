        ...
        <div className="col-lg-5">
          <div className="sec-head md-mb80 wow fadeIn">
            ...
            <ul className="rest social-text d-flex mt-60">
              <li className="mr-30">
                <a href="https://www.facebook.com/sanjitabhujel12347/" className="hover-this">
                  <span className="hover-anim">Facebook</span>
                </a>
              </li>
              <li className="mr-30">
                <a href="https://github.com/bhujelsanjita" className="hover-this">
                  <span className="hover-anim">Github</span>
                </a>
              </li>
              <li className="mr-30">
                <a href="https://www.linkedin.com/in/sanjita-bhujel-b31151242/" className="hover-this">
                  <span className="hover-anim">LinkedIn</span>
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/bhujel_sanjita/" className="hover-this">
